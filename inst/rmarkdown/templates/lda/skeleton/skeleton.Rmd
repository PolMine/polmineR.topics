...
```{r}
speeches <- as.speeches(.Object = corpus, s_attribute_date = "date", s_attribute_name = "name")
count_bundle <- count(speeches, p_attribute = "word", verbose = TRUE)
rm(speeches)
```
...
dtm <- as.DocumentTermMatrix(count_bundle, p_attribute = "word", col = "count")
```
